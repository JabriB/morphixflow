...
export const ar: Dictionary = {
  ...
  cookieConsent: {
    heading: 'قرارك بشأن التتبّع',
    body:
      'يعمل هذا الموقع دون تتبّع. لأغراض القياس والإعلان سنحمّل خدمات إضافية تخزّن بيانات على جهازك وترسلها إلى مزوّديها. لن يحدث ذلك إلا بموافقتك.',
    acceptAll: 'قبول الكل',
    rejectAll: 'الضروري فقط',
    save: 'حفظ الاختيار',
    settings: 'الإعدادات',
    close: 'إغلاق',
    privacyLink: 'سياسة الخصوصية',
    footerLabel: 'إعدادات ملفات تعريف الارتباط',
    withdraw: 'سحب الموافقة',
    categories: {
      necessary: {
        name: 'ضرورية',
        body:
          'تُبقي الموقع صالحاً للعمل، مثل اختيارك للغة والتصميم. لا يعمل الموقع بدونها، ولذلك لا تتطلب موافقة.',
        always: 'مفعّلة دائماً',
      },
      statistics: {
        name: 'إحصاءات',
        body: 'تُظهر بشكل مجهول أي المحتويات تُقرأ وأين يغادر الزوّار.',
      },
      marketing: {
        name: 'تسويق',
        body:
          'تقيس أي إعلان أدى إلى طلب، وتتيح الوصول إليك مجدداً على منصات أخرى.',
      },
    },
    providedBy: 'المزوّد',
  },
